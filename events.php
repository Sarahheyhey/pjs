    ...
    <ul>
        <li>
            <div class="content">
                ...
                <button class="events-knap">
                    <a href="https://pjscoffeevietnam.com/bbgv-hcm-18th-fun-run-for-charity/">
                        <h2>Read More</h2>
                    </a>
                </button>
            </div>
        ...
        <li>
            <div class="content">
                ...
                <button class="events-knap">
                    <a href="https://pjscoffeevietnam.com/3210-challenge-3-weeks-21-challenges-0-plastic/">
                        <h2>Read More</h2>
                    </a>
                </button>
            </div>
        ...
        <li>
            <div class="content">
                ...
                <button class="events-knap">
                    <a href="https://pjscoffeevietnam.com/change-for-sustainable-living-with-pjs-coffee-at-go-green-day-2018/">
                        <h2>Read More</h2>
                    </a>
                </button>
            </div>
        ...
        <li>
            <div class="content">
                <div class="image-container">
                    <img alt="Sustainable living with PJ's Coffee" src="images/TRG-Talk-Project-Management.jpg">
                </div>
                <h2>
                ...
                <button class="events-knap">
                    <a href="https://pjscoffeevietnam.com/trg-talk-project-management-ipmav/">
                        <h2>Read More</h2>
                    </a>
                </button>
            </div>
        ...
        <li>
            <div class="content">
                <div class="image-container">
                    <img alt="TRG Talk with PJ's Coffee and TRG International" src="images/trg-talk.jpg">
                </div>
                <h2>
                ...
                <button class="events-knap">
                    <a href="https://pjscoffeevietnam.com/trg-talk-talent-vision-expectations-ceos-hr-next-5-years/">
                        <h2>Read More</h2>
                    </a>
                </button>
            </div>
        ...
        <li>
            <div class="content">
                <div class="image-container">
                    <img alt="TRG Talk with PJ's Coffee and TRG International" src="images/trg-talk-2.jpg">
                </div>
                <h2>
                ...
                <button class="events-knap">
                    <a href="https://pjscoffeevietnam.com/trg-talk-office-365-api/">
                        <h2>Read More</h2>
                    </a>
                </button>
            </div>
        ...
        <li>
            <div class="content">
                <div class="image-container">
                    <img alt="TRG Talk with PJ's Coffee and TRG International" src="images/coffee-work.jpg">
                </div>
                <h2>
